...
exports.getProductInfobySearch = async(req, res, next) => {
  ...
  console.log("body data1",req.body);
    ...
    console.log("body data",req.body);
      ...
      let data=await Product.find({$or: [{property_type : { $in : property_type}},{title:title},{minprice:minprice},{maxprice:maxprice},{bedrooms:bedrooms},{bathrooms:bathrooms},{floor_size:floor_size},{erf_size:erf_size},{pet_friendly:pet_friendly},{garden:garden},{pool:pool},{flatlet:flatlet},{retirement:retirement},{repossessed:repossessed},{on_show:on_show},{auction:auction},{parking:parking}]})
      .then(t1=>{
        console.log(t1);
        if(t1){
